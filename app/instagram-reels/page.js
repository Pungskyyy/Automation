      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          ...
          <p style={{ color: "rgba(255, 255, 255, 0.8)", fontSize: "14px" }}>
            Otomatis kirim comment ke Instagram Reels
          </p>
        </div>
        ...
        <div style={{ marginBottom: "16px" }}>
          <label style={{ color: "white", fontSize: "14px", display: "block", marginBottom: "8px" }}>🔗 Instagram Reels URL</label>
          <input
            type="text"
            value={igReelsUrl}
        ...
        <button
          ...
          style={{
            ...
            padding: "14px 20px",
            borderRadius: "12px",
            background: loading || selectedDevices.length === 0 ? "rgba(100, 100, 100, 0.5)" : "linear-gradient(135deg, #fa709a 0%, #fee140 100%)",
            color: "white",
            fontWeight: "bold",
            fontSize: "16px",
            border: "none",
