      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          ...
          <p style={{ color: "rgba(255, 255, 255, 0.8)", fontSize: "14px" }}>
            Otomatis kirim comment ke TikTok Post/Photo
          </p>
        </div>

        {/* Device Selection - sama seperti IG Post */}
        <div 
          style={{ 
        ...
        <div style={{ marginBottom: "16px" }}>
          <label style={{ color: "white", fontSize: "14px", display: "block", marginBottom: "8px" }}>🔗 TikTok Post URL</label>
          <input
            type="text"
            value={tiktokPostUrl}
            onChange={(e) => setTiktokPostUrl(e.target.value)}
            placeholder="https://www.tiktok.com/@username/photo/123456..."
            style={{ 
              width: "100%", 
              padding: "12px 16px", 
              borderRadius: "10px", 
        ...
        <button
          ...
          style={{
            ...
            padding: "14px 20px",
            borderRadius: "12px",
            background: loading || selectedDevices.length === 0 ? "rgba(100, 100, 100, 0.5)" : "linear-gradient(135deg, #00d2ff 0%, #3a7bd5 100%)",
            color: "white",
            fontWeight: "bold",
            fontSize: "16px",
            border: "none",
          ...
          onMouseEnter={(e) => {
            if (!loading && selectedDevices.length > 0) {
              e.currentTarget.style.transform = "scale(1.02)";
              e.currentTarget.style.boxShadow = "0 8px 20px rgba(0, 210, 255, 0.4)";
            }
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = "scale(1)";
