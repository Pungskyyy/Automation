      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          ...
          <p style={{ color: "rgba(255, 255, 255, 0.8)", fontSize: "14px" }}>
            Otomatis kirim comment ke TikTok Video
          </p>
        </div>
        ...
        <div style={{ marginBottom: "16px" }}>
          <label style={{ color: "white", fontSize: "14px", display: "block", marginBottom: "8px" }}>🔗 TikTok Video URL</label>
          <input
            type="text"
        ...
        <button
          ...
          style={{
            ...
            padding: "14px 20px",
            borderRadius: "12px",
            background: loading || selectedDevices.length === 0 ? "rgba(100, 100, 100, 0.5)" : "linear-gradient(135deg, #ee0979 0%, #ff6a00 100%)",
            color: "white",
            fontWeight: "bold",
            fontSize: "16px",
            border: "none",
          ...
          onMouseEnter={(e) => {
            if (!loading && selectedDevices.length > 0) {
              e.currentTarget.style.transform = "scale(1.02)";
              e.currentTarget.style.boxShadow = "0 8px 20px rgba(238, 9, 121, 0.4)";
            }
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.transform = "scale(1)";
